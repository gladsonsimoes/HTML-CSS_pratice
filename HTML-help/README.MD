<div align="center">
     <h1> <p> Tags de HTML <p> </h1>
       <h4>  este documento tem algumas tags principais do html  </h4>
...
<a href="https://github.com/gladsonsimoes/HTML-CSS_pratice/blob/main/HTML-help/doctype.md"> sobre o doctype </a>
</a>
...
Tag <sub> – O texto dentro da tag <sub> se torna subscrito (letras pequenas abaixo de um texto)
Tag <sup> – Coloca o texto como sobrescrito (letras pequenas acima de um texto).
...
a sintaxe fica assim com seus atributos:
~~~html
...
### label
Pinserimos uma tag label para cada elemento, a fim de facilitar a identificação de cada um. <br>
~~~html
<label></label>	
~~~	
<a href="https://github.com/gladsonsimoes/HTML-CSS_pratice/blob/main/HTML-help/Html_arquives/usandoLabel.html"> exemplo usando label </a>	

## botão button

~~~html
<button type="submit">Cadastrar</a>
~~~
...
### Lista de opções ou menu , SELECT
